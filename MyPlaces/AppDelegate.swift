...
//            manager.append( Place(locationName: "UOC 22@", myDescription: "Seu de la Universitat Oberta de Catalunya",  image_in: UIImage(named: "BavarianChurchSnow1")) )
            manager.append( Place(id: "1", type: .generic, locationName: "Plaza Cataluña 1, Barcelona 08001, Spain", myDescription: "The very center of Barcelona, the most global and cosmopolitan town in Europe." , coordinate: CLLocationCoordinate2D(latitude: 41.381760, longitude: 2.167330), www: "", image: UIImage(named:"PlazaCatalunya1"),  title: "Plaça Catalunya", discipline: "") )
            manager.append( Place(id: "2", type: .touristic, locationName: "Parc Güell 1, Barcelona, Spain", myDescription: "You can't forget to visit this emblematic place in Barcelona" , coordinate: CLLocationCoordinate2D(latitude: 41.496280, longitude: 2.338800), www: "", image: UIImage(named:"ParcGüell1"),  title: "Parc Güell", discipline: "") )
